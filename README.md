...
Follow these steps to get the environment configured and ready to run.

### Prerequisites
* Ensure you have [Node.js / Python - *Keep the one you used*] installed.
* An active API key for [OpenAI / Anthropic / Gemini - *Insert your LLM provider*].
